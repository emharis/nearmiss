  ...
  BFHDatePicker.prototype = {
    ...
    initCalendar: function() {
      ...
      this.$element
        ...
        .on('change', '.bfh-datepicker-calendar > table.calendar .month > .select-month', BFHDatePicker.prototype.setMonth)
        .on('change', '.bfh-datepicker-calendar > table.calendar .year > .select-year', BFHDatePicker.prototype.setYear)
    ...
    updateCalendarHeader: function($calendar, month, year) {
      ...
      if(this.options.selectbox==true){
          $calendar.find('table > thead > tr > th.year > select.select-year').val(year);
          $calendar.find('table > thead > tr > th.month > select.select-month').val(month);
      }
    },
...
//      alert('set month select-month');
      ...
      $parent.data('month', Number($month));
...
//      alert('select year');
      ...
      $parent.data('year', Number($year));
      
      //update select year option
//      $calendar = this.$element.find('.bfh-datepicker-calendar');
      
      //generate year option
      var lastYr  =  Number($this.find(":last").val());
      var firstYr  =  Number($this.find(":first").val());
      
      if($year == lastYr){
          $this.empty();
          for(var i=lastYr;i<=(lastYr+10);i++){
            $this.append($('<option/>', { 
                value: i,
                text : i
            }));
          }
      }else if($year == firstYr){
          $this.empty();
          for(var i=firstYr-10;i<=(firstYr);i++){
            $this.append($('<option/>', { 
                value: i,
                text : i
            }));
...
//      if($year == firstYr){
//          $this.empty();
//          for(var i=firstYr;i<(firstYr-10);i++){
//            $this.append($('<option/>', { 
//                value: i,
//                text : i
//            }));
...
//          $calendar.find('table > thead > tr > th.year > select.select-year').append($('<option/>', { 
//              value: i,
//              text : i
//          }));
//        }
    ...
    useSelectBox: function(e){
      ...
      $calendar = this.$element.find('.bfh-datepicker-calendar');
         ...
         /* MONTH & YEAR WITH SELECT BOX
        * ============== */

//       $('.months-header ').addClass('small');
         $calendar.find('table > thead > tr > th.month').empty();
         $calendar.find('table > thead > tr > th.month').append('<select class="select-month form-control">'+
                 ...
                 '</select>');
        $calendar.find('table > thead > tr > th.year').empty();
        $calendar.find('table > thead > tr > th.year').append('<select class="select-year form-control"></select>');
         
         //set select box bulan ke bulan sekarang
...
//     
////    $(document).on('change','.months-header .month .select-month',function(){
////
////    });
//  }

  ...
  * ========================= */
  ...
  , initCalendar: function() {
    ...
    if (date == "") {
      ...
      this.$element.find('input[type=text].date-input').val(date)
      this.$element.find('div.date-text-label').text(this.getDateText(this.parse("m", date) - 1, this.parse("y", date), this.parse("d", date)));
  ...
  , previousYear: function (e) {
    ...
    $parent.data('year', new Number($parent.data('year')) - 1)
     $("#id-tahun>option[value='"+(new Number($parent.data('year')) - 1)+"']").attr('selected', 'selected');
    $datePicker = $parent.data('bfhdatepicker')
    $datePicker.updateCalendar()
  ...
  ,selectYear: function(e){
    ...
    var yearselected = $('#id-tahun').val();

    $parent.data('year', new Number(yearselected))
  ...
  , select: function (e) {
    ...
    $parent.find('input[type=text].date-input').val($datePicker.formatDate(month, year, day)).trigger('change')
    $parent.find('div.date-text-label').text($datePicker.getDateText(month, year, day))
  ...
  , getDateText: function(month, year, day) {
      return BFHDaysList[this.dayOfWeek(month, year, day)]+', '+day+' '+BFHMonthsList[month]+' '+year;
    }
  }
  ...
  $(function () {
    ...
    $('#id-tahun').on('change', BFHDatePicker.prototype.selectYear)

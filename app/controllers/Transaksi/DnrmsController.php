...
class DnrmsController extends \BaseController {
    ...
    function getIndex() {
        ...
        return \View::make('Transaksi/Dnrms/index', [
                    'colarr' => $this->colarr,
                    'data' => $data,
                    'opData' => $opData,
                    'ckData' => $ckData,
...
//        return \View::make('Transaksi/Dnrms/new', [
        return \View::make('Transaksi/Dnrms/popnew', [
    ...
    function getShow($id) {
        ...
        return \View::make('Transaksi/Dnrms/popshow', [
                    'data' => $data,
//                    'selectPic' => $selectPic,
                    'dataFoto' => $dataFoto,
        ]);
    ...
    function getEdit($id) {
        ...
        return \View::make('Transaksi/Dnrms/popedit', [
                    'selectLokasi' => $selectLokasi,
                    'selectJenisPekerjaan' => $selectJenisPekerjaan,
                    'selectHubungan' => $selectHubungan,
                    'selectJenisBahaya' => $selectJenisBahaya,
...
//        return public_path().'/uploads/'.$img->local_img;
    ...
    function getNewOption($table, $title) {
        if ($table == 'vendor') {
            return \View::make('Transaksi/Dnrms/popnewoption', [
                        'table' => $table,
                        'title' => $title,
            ]);
        } else {
...
//        return \Redirect::back();
    ...
    function getOption($tableName, $title, $hiddenField, $namaField) {
        ...
        return \View::make('Transaksi/Dnrms/popoption', array(
                    'data' => $data,
                    'title' => $title,

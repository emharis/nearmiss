...
class ClnrmsController extends \BaseController {
    ...
    function getIndex() {
        ...
        return \View::make('Transaksi/Clnrms/index', [
                    'colarr' => $this->colarr,
        ]);
    }
    ...
    function getOpenData($filter = '', $awal = '', $akhir = '', $kolom = '', $filter_text = '') {
        ...
        return \View::make('Transaksi/Clnrms/datatable', [
                    'data' => $opData,
        ]);
    }
    ...
    function getCheckedData($filter = '', $awal = '', $akhir = '', $kolom = '', $filter_text = '') {
        ...
        return \View::make('Transaksi/Clnrms/checkeddata', [
                    'data' => $ckData,
        ]);
    }
    ...
    function getClosedData($filter = '', $awal = '', $akhir = '', $kolom = '', $filter_text = '') {
        ...
        return \View::make('Transaksi/Clnrms/closeddata', [
                    'data' => $clData,
        ]);
    }
...
//
    ...
    function getShow($id) {
        ...
        return \View::make('Transaksi/Clnrms/popshow', [
                    'data' => $data,
//                    'selectPic' => $selectPic,
                    'dataFoto' => $dataFoto,
        ]);
    ...
    function getEdit($id) {
        ...
        return \View::make('Transaksi/Clnrms/popedit', [
...
//        return public_path().'/uploads/'.$img->local_img;
    ...
    function getNewOption($table, $title) {
        if ($table == 'vendor') {
            return \View::make('Transaksi/Clnrms/popnewoption', [
                        'table' => $table,
                        'title' => $title,
            ]);
        } else {
...
//        return \Redirect::back();
    ...
    function getOption($tableName, $title, $hiddenField, $namaField) {
        ...
        return \View::make('Transaksi/Clnrms/popoption', array(
                    'data' => $data,
                    'title' => $title,

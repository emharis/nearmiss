...
class NrmssysController extends \BaseController {
    ...
    function getIndex() {
        ...
        $data = \DB::table('VIEW_TEMUAN')->whereBetween('tgl', array(date('Y-m-d'), date('Y-m-d')))->paginate(\Helpers::constval('show_number_datatable'));


        return \View::make('Transaksi/Nrmssys/index', [
                    'data' => $data,
                    'colarr' => $this->colarr
        ]);
    }
...
//        return \View::make('Transaksi/Nrmssys/new', [
        return \View::make('Transaksi/Nrmssys/popnew', [
    ...
    function getShow($id) {
        ...
        return \View::make('Transaksi/Nrmssys/popshow', [
                    'data' => $data,
//                    'selectPic' => $selectPic,
                    'dataFoto' => $dataFoto,
        ]);
...
//        return \View::make('Transaksi/Nrmssys/new', [
        return \View::make('Transaksi/Nrmssys/popedit', [
                    'selectLokasi' => $selectLokasi,
                    'selectJenisPekerjaan' => $selectJenisPekerjaan,
                    'selectHubungan' => $selectHubungan,
                    'selectJenisBahaya' => $selectJenisBahaya,
...
//        return public_path().'/uploads/'.$img->local_img;
    ...
    function getNewOption($table, $codeprefix, $header) {
        if ($table == 'vendor') {
            return \View::make('Transaksi/Nrmssys/newvendor', [
                        'table' => $table,
                        'header' => $header,
                        'codeprefix' => $codeprefix,
            ]);
        } else {
            return \View::make('Transaksi/Nrmssys/newoption', [
                        'table' => $table,
                        'header' => $header,
                        'codeprefix' => $codeprefix,
            ]);

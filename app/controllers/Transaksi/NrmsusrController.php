...
class NrmsusrController extends \BaseController {
    ...
    function getIndex() {
        ...
        return \View::make('Transaksi/Nrmsusr/index', [
                    'data' => $data,
                    'colarr' => $this->colarr
        ]);
    }
    ...
    function postFilter() {
        ...
        $data = \DB::table('VIEW_TEMUAN')
                ->where('username',\Session::get('onusername'))
...
//        return \View::make('Transaksi/Nrmsusr/new', [
        return \View::make('Transaksi/Nrmsusr/popnew', [
    ...
    function getShow($id) {
        ...
        return \View::make('Transaksi/Nrmsusr/popshow', [
                    'data' => $data,
//                    'selectPic' => $selectPic,
                    'dataFoto' => $dataFoto,
        ]);
    ...
    function getEdit($id) {
        ...
        return \View::make('Transaksi/Nrmsusr/popedit', [
                    'selectLokasi' => $selectLokasi,
                    'selectJenisPekerjaan' => $selectJenisPekerjaan,
                    'selectHubungan' => $selectHubungan,
                    'selectJenisBahaya' => $selectJenisBahaya,
...
//        return public_path().'/uploads/'.$img->local_img;
    ...
    function getNewOption($table, $codeprefix, $header) {
        if ($table == 'vendor') {
            return \View::make('Transaksi/Nrmsusr/newvendor', [
                        'table' => $table,
                        'header' => $header,
                        'codeprefix' => $codeprefix,
            ]);
        } else {
            return \View::make('Transaksi/Nrmsusr/newoption', [
                        'table' => $table,
                        'header' => $header,
                        'codeprefix' => $codeprefix,
            ]);

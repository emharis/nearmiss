...
class NrmspicController extends \BaseController {
...
//        return \View::make('Transaksi/Nrmspic/new', [
        return \View::make('Transaksi/Nrmspic/popnew', [
    ...
    function getShow($id) {
        ...
        return \View::make('Transaksi/Nrmspic/popshow', [
                    'data' => $data,
//                    'selectPic' => $selectPic,
                    'dataFoto' => $dataFoto,
        ]);
...
//        return \View::make('Transaksi/Nrmspic/new', [
        return \View::make('Transaksi/Nrmspic/popedit', [
                    'selectLokasi' => $selectLokasi,
                    'selectJenisPekerjaan' => $selectJenisPekerjaan,
                    'selectHubungan' => $selectHubungan,
                    'selectJenisBahaya' => $selectJenisBahaya,
...
//        return public_path().'/uploads/'.$img->local_img;
    ...
    function getNewOption($table, $codeprefix, $header) {
        if ($table == 'vendor') {
            return \View::make('Transaksi/Nrmspic/newvendor', [
                        'table' => $table,
                        'header' => $header,
                        'codeprefix' => $codeprefix,
            ]);
        } else {
            return \View::make('Transaksi/Nrmspic/newoption', [
                        'table' => $table,
                        'header' => $header,
                        'codeprefix' => $codeprefix,
            ]);

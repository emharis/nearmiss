...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <div class="pull-right" >
                <a href="trans/nrmsusr/new" class="btn btn-primary pull-right" id="btnNew">New</a>
            </div>
        </h1>
    </section>
    ...
    <section class="content">
        <div class="box box-solid" >
            <div class="box-body" >
                <form action="trans/nrmsusr/filter" method="POST" >
                    <h4>Filter : </h4>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="col-md-2" >
                                    ...
                                    @if(isset($isfilter))
                                    <a href="trans/nrmsusr" class="btn btn-sm btn-warning" >Clear Filter</a>
                                    @endif
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <tbody>
                        ...
                        <tr   >
                            ...
                            <td class="text-center">
                                <div class="btn-group" >
                                    <a class="btn btn-primary btn-xs btnEdit" href="trans/nrmsusr/edit/{{$dt->id}}" >Edit</a>
                                    <a class="btn btn-success btn-xs btnShow" href="trans/nrmsusr/show/{{$dt->id}}" >Show</a>    
                                    <a class="btn btn-danger btn-xs btnDelete" href="trans/nrmsusr/delete/{{$dt->id}}" >Delete</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach

...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <div class="pull-right" >
                <a href="trans/nrmspic/new" class="btn btn-primary pull-right" id="btnNew">New</a>
            </div>
        </h1>
    </section>
    ...
    <section class="content">
        <div class="box box-solid" >
            <div class="box-body" >
                <form action="trans/nrmspic/filter" method="POST" >
                    <h4>Filter : </h4>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="col-md-2" >
                                    ...
                                    @if(isset($isfilter))
                                    <a href="trans/nrmspic" class="btn btn-sm btn-warning" >Clear Filter</a>
                                    @endif
                                </td>
                            </tr>
                        </tbody>

...
<div class="content-wrapper for-overlay ">
    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form method="POST" action="trans/nrmspic/edit" class="" enctype="multipart/form-data" >
                                ...
                                <td  colspan="7">
                                    <div class="row" id="image-preview" >
                                        ...
                                        <div class="col-sm-3" >
                                            <div class = "box box-primary " >
                                                <div class = "box-body" >
                                                    <a href="trans/nrmspic/delfoto" data-imgid="{{$dt->id}}" id="btn_del_img_{{$dt->id}}" class = "btn-del-image" > <i class = "fa fa-times pull-right" > </i></a >
...
//close form
    ...
    var uploader = new plupload.Uploader({
        ...
        url: "{{URL::to('trans/nrmspic/upload')}}",
        resize: {
            width: 400,
            quality: 90
        },
...
//==============end of plupload===========
    ...
    $('.btnNewOption').click(function () {
        ...
        var url = 'trans/nrmspic/new-option/' + $(this).data('tablename') + '/' + $(this).data('prefix') + '/' + $(this).data('header');

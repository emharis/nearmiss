                    ...
                    <table class="table table-bordered table-condensed" >
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="tgl-koreksi" readonly class="form-control" value="{{date('d-m-Y',strtotime($data->tgl_koreksi))}}"
                                </td>
                                <td >
                            ...
                            <tr>
                                ...
                                <td colspan="3"  >
                                    <textarea name="koreksi" readonly class="form-control" rows="3" >{{$data->koreksi}}</textarea>
                                </td>
                                        ...
                                        <div class="col-sm-3"  >
                                            <div class = "box box-success " >
                                                <div class = "box-body img-container"  >                                                    
                                                    ...
                                                    @else
                                                    <a href="{{'data:image/'.$dt->type.';base64,'.$dt->img}}" data-lightbox="img-prev-koreksi" >
                                                        <img id = "img_{{$dt->id}}" src = "{{'data:image/'.$dt->type.';base64,'.$dt->img}}" class = "img-prev"  />
                                                    </a>  

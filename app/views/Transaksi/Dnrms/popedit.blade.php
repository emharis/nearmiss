...
{{Form::textarea('tindakan_tidak_aman',$data->tindakan,array('class'=>'form-control','rows'=>'3','required'))}}
                            ...
                            <tr>
                                ...
                                <td class="col-sm-3" colspan="2" >
                                    {{Form::textarea('pencegahan',$data->pencegahan,array('class'=>'form-control','rows'=>'3','required'))}}
                                </td>
                            </tr>
                            <tr>
                                <td >
                                        ...
                                        <div class="col-sm-3"  >
                                            <div class = "box box-primary " >
                                                ...
                                                <div class="box-footer text-right" >
                                                    <a href="trans/nrms/delfoto" data-imgid="{{$dt->id}}" id="btn_del_img_{{$dt->id}}" class = "btn-del-image btn btn-danger btn-xs" > Delete</a >
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
            ...
            plupload.each(files, function (file) {
                ...
                img.onload = function () {
                    ...
                    $('#image-preview').append(
                            ...
                            '<img id = "img_' + num + 'x" src = "' + this.getAsDataURL() + '" class = "img-prev"  />' +
                            '</a>' +
                            '</div>' +
                            '<div class="box-footer text-right" >' +
                            '<a href="#" data-imgid="' + file.id + '" data-num="' + num + '" id = "btn_del_img_' + num + '" class = "btn-del-image btn btn-xs btn-danger" >Delete</a >' +
                            '</div>' +
                            '</div>' +
                            '</div>');
                    num++;

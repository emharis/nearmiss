...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <div class="pull-right" >
                <a href="trans/dnrms/new" class="btn btn-sm btn-primary pull-right" id="btnNew">New</a>
            </div>
        </h1>
    </section>
    ...
    <section class="content">
                <div class="box box-solid">
                    <form action="trans/dnrms/filter" method="POST" >
                        <div  class="box-body" >
                            <h4>Filter : </h4>
                        ...
                        <div class="box-footer text-right" >
                            ...
                            @if(isset($isfilter))
                            <a id="btn-clear-filter" href="trans/dnrms" class="btn btn-sm btn-warning" >Clear Filter</a>
                            @endif                    
                        ...
                        <table class="table table-bordered table-condensed" >
                            <thead>
                                <tr>
                                    ...
                                    <th>Lokasi</th>                       
                                    <th>Jenis Bahaya</th>
                                    jika user adalah administrator maka kolom ini ditampilkan
                                    @if($onuser->is('SA'))
                                    <th>User Issue</th>
                                    @endif
                                    <th>PIC</th>
        ...
        <?php $rownum = 1; ?>
                                ...
                                <tr   >
                                    ...
                                    @endif
                                    <td>
                                        {{isset($dt->pic_name)?$dt->pic_name:'-'}}
                                    </td>   
                                    <td class="text-center">
                                        <div class="btn-group" >
                                            @if($dt->status == 'OP')
                                            <a class="btn btn-primary btn-xs btnEdit" href="trans/dnrms/edit/{{$dt->id}}" >Edit</a>
                                            @else
                                            <a class="btn btn-success btn-xs btnShow" href="trans/dnrms/show/{{$dt->id}}" >Show</a>    
                                            @endif
                                            <a class="btn btn-danger btn-xs btnDelete" href="trans/dnrms/delete/{{$dt->id}}" >Delete</a>    
                                        </div>
                                    </td>
                                </tr>
                                @endforeach

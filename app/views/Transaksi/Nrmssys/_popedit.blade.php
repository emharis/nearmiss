    ...
    <section class="content">
        <div class="box box-solid">
            <div class="box-header" >
                <h4>
                    Edit Data Kecelakaan Kerja/Nearmiss 
                                    ...
                                    <div class="row" id="image-preview" >
                                        ...
                                        <div class="col-sm-3" >
                                            <div class = "box box-primary" >
                                                <div class = "box-body" >
                                                    <a data-isfromdb="Y"  class = "btn-del-image-fromdb" data-id="{{$dt->id}}" > <i class = "fa fa-times pull-right" > </i></a >
...
//                                                $('#img_' + (num) + 'x').attr('src', null);
    $('#btn_del_img_' + num).parent().parent().parent().hide();
...
//delete image yang sudah ada sebelulmnya
$('.btn-del-image-fromdb').click(function (e) {
    var id = $(this).data('id');
    var container = $(this).parent().parent().parent();
    if (confirm('Hapus foto ini dari database?')) {
        $.post('trans/nrmssys/delfoto', {
            'id': id
        }, function (res) {

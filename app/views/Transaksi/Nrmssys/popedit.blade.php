...
<div class="content-wrapper for-overlay ">
    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form method="POST" action="trans/nrmssys/edit" class="" enctype="multipart/form-data" >
                    ...
                    <table class="table table-bordered table-condensed" >
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="col-sm-3" colspan="2" >
                                    {{Form::select('user_issue',$selectUserIssue,$data->user_id,array('class'=>'employees select-search form-control','data-live-search'=>'true','data-live-search'=>'true','title'=>' ','required'))}}
                                </td>
                            </tr>
                            <tr>
                                <td class="col-sm-2" >
                            ...
                            <tr>
                                ...
                                <td class="col-sm-3" colspan="2">
                                    {{Form::textarea('pencegahan',$data->pencegahan,array('class'=>'form-control','rows'=>'3'))}}
                                </td>
                                <td></td>
                                <td class="col-sm-2" >
                                    Koreksi
                                ...
                                <td class="col-sm-3" colspan="2" >
                                    {{Form::textarea('koreksi',$data->koreksi,array('class'=>'form-control','rows'=>'3'))}}
                                </td>
                            </tr>
                            <tr>
                                <td class="col-sm-2" >
                                ...
                                <td class="col-sm-3" colspan="2">
                                    <div id="input-tgl-koreksi" data-input="form-control" class="bfh-datepicker" data-format="d-m-y" data-date="{{date('d-m-Y',strtotime($data->tgl_koreksi))}}" data-name="tgl_koreksi" ></div>
                                </td>
                                <td></td>
                                <td class="col-sm-2" >
                                    Status
                                ...
                                <td  colspan="3">
                                    <div class="row" id="image-preview" >
                                        ...
                                        <div class="col-sm-6" >
                                            <div class = "box box-primary " >
                                                <div class = "box-body" >
                                                    <a href="trans/nrmssys/delfoto" data-imgid="{{$dt->id}}" id="btn_del_img_{{$dt->id}}" class = "btn-del-image" > <i class = "fa fa-times pull-right" > </i></a >
                                    ...
                                    <div class="row" id="image-preview-perbaikan" >
                                        ...
                                        <div class="col-sm-6" >
                                            <div class = "box box-warning " >
                                                <div class = "box-body" >
                                                    <a data-imgid="{{$dt->id}}" id = "btn_del_img_{{$dt->id}}" class = "btn-del-image" > <i class = "fa fa-times pull-right" > </i></a >
                                                    <a href="uploads/{{$dt->local_img}}" data-lightbox="img-prev" ><img id = "img_{{$dt->id}}" src = "uploads/{{$dt->local_img}}" class = "col-sm-12 img-prev" width = "100%" height="100px" /></a>
                                                </div>
                                            </div>
                                        </div>
...
//============PLUPLOAD 2==================
    ...
    uploader2.init();
//    var num2 = 1;
    var imgCount2 = parseInt($('input[name=imgCount2]').val());

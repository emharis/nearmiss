...
<div class="content-wrapper for-overlay ">
    ...
    <section class="content">
        <div class="box box-primary" >
            <form method="POST" action="trans/pnrms/new" enctype="multipart/form-data" >
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-6" >
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input   data-hidden="lokasi_id" data-title="Pilih Data Lokasi" data-table="sf_lokasi"  type="text" name="lokasi" class="hide form-control input-option"/>
                        ...
                        <div class="col-md-6" >
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input  data-hidden="jenis_pekerjaan_id" data-title="Pilih Data Jenis Pekejaan" data-table="sf_jenis_pekerjaan"  type="text" name="jenis_pekerjaan" class="hide form-control input-option"/>
                        ...
                        <div class="col-md-6" >
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input  data-hidden="hubungan_id" data-title="Pilih data hubungan antar plant" data-table="sf_hubungan"  type="text" name="hubungan" class="hide form-control input-option"/>
                                    {{Form::select('cbhubungan',$selectHubungan,null,array('data-id'=>'hubungan_id','data-textbox'=>'hubungan','required','class'=>'sf_hubungan select-search form-control','data-live-search'=>'true','title'=>' '))}}
                                    <span class="input-group-btn">
                        ...
                        <div class="col-md-6" >
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input  data-hidden="jenis_bahaya_id" data-title="Pilih Data Jenis Bahaya" data-table="sf_jenis_bahaya"  type="text" name="jenis_bahaya" class="hide form-control input-option"/>
                                    {{Form::select('cbjenis_bahaya',$selectJenisBahaya,null,array('data-id'=>'jenis_bahaya_id','data-textbox'=>'jenis_bahaya','required','class'=>'sf_jenis_bahaya select-search form-control','data-live-search'=>'true','title'=>' ',''))}}
                                    <span class="input-group-btn">
                        ...
                        <div class="col-md-6" >
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input  data-hidden="anggota_badan_id" data-title="Pilih Data Anggota Badan" data-table="sf_anggota_badan"  type="text" name="anggota_badan" class="hide form-control input-option"/>
                                    {{Form::select('cbanggota_badan',$selectAnggotaBadan,null,array('data-id'=>'anggota_badan_id','data-textbox'=>'anggota_badan','required','class'=>'sf_anggota_badan select-search form-control','data-live-search'=>'true','title'=>' '))}}
                                    <span class="input-group-btn">
                        ...
                        <div class="col-md-6" >
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input  data-hidden="klasifikasi_id" data-title="Pilih Data Klasifikasi" data-table="sf_klasifikasi"  type="text" name="klasifikasi" class="hide form-control input-option"/>
                                    {{Form::select('cbklasifikasi',$selectKlasifikasi,null,array('data-id'=>'klasifikasi_id','data-textbox'=>'klasifikasi','required','class'=>'sf_klasifikasi select-search form-control','data-live-search'=>'true','title'=>' '))}}
                                    <span class="input-group-btn">
                        ...
                        <div class="col-md-6" >
                            <div class="form-group">
                                ...
                                <input  data-hidden="pic_id" data-title="Pilih Data PIC" data-table="employees"  type="text" name="pic" class="hide form-control input-option"/>
                                {{Form::select('pic',$selectPic,null,array('data-id'=>'pic_id','data-textbox'=>'pic','required','class'=>'employees select-search form-control','data-live-search'=>'true','data-live-search'=>'true','title'=>' ',''))}}
                        ...
                        <div class="col-md-6" >
                            <div class="form-group">
                                <label >Cedera</label>
                                <div class="input-group">
                                    <input  data-hidden="cedera_id" data-title="Pilih Data Cedera" data-table="sf_cedera"  type="text" name="cedera" class="hide form-control input-option"/>
                                    {{Form::select('cbcedera',$selectCedera,null,array('data-id'=>'cedera_id','data-textbox'=>'cedera','required','class'=>'sf_cedera select-search form-control','data-live-search'=>'true','title'=>' '))}}
                                    <span class="input-group-btn">
                        ...
                        <div class="col-md-6" >
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input  data-hidden="sumber_penyebab_id" data-title="Pilih Data Sumber Penyebab" data-table="sf_sumber_penyebab"  type="text" name="sumber_penyebab" class="hide form-control input-option"/>
                                    {{Form::select('cbsumber_penyebab',$selectSumberPenyebab,null,array('data-id'=>'sumber_penyebab_id','data-textbox'=>'sumber_penyebab','required','class'=>'sf_sumber_penyebab select-search form-control','data-live-search'=>'true','title'=>' ',''))}}
                                    <span class="input-group-btn">
                        ...
                        <div class="col-md-6" >
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input  data-hidden="keadaan_id" data-title="Pilih Data Keadaan" data-table="sf_keadaan"  type="text" name="keadaan" class="hide form-control input-option"/>
                                    {{Form::select('cbkeadaan',$selectKeadaan,null,array('data-id'=>'keadaan_id','data-textbox'=>'keadaan','required','class'=>'sf_keadaan select-search form-control','data-live-search'=>'true','title'=>' '))}}
                                    <span class="input-group-btn">
                        ...
                        <div class="col-md-6" >
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input  data-hidden="kontraktor_id" data-title="Pilih Data Kontraktor Celaka" data-table="sf_cedera"  type="text" name="kontraktor" class="hide form-control input-option"/>
                                    {{Form::select('cbkontraktor_ceaka',$selectCedera,null,array('data-id'=>'kontraktor_id','data-textbox'=>'kontraktor','required','class'=>'sf_cedera select-search form-control','data-live-search'=>'true','title'=>' '))}}
                                    <span class="input-group-btn">
                                        <a class="btn btn-info btn-add-option" type="button" data-table="sf_cedera" data-title="Input Data Cedera"  ><i class="fa fa-plus" ></i></a>
                                    </span>
                                </div>
                        ...
                        <div class="col-md-6" >
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input  data-hidden="jenis_kontraktor_id" data-title="Pilih Jenis Kontraktor" data-table="vendor"  type="text" name="jenis_kontraktor" class="hide form-control input-option"/>
                                    {{Form::select('cbvendor',$selectVendor,null,array('data-id'=>'jenis_kontraktor_id','data-textbox'=>'jenis_kontraktor','required','class'=>'vendor select-search form-control','data-live-search'=>'true','title'=>' '))}}
                                    <span class="input-group-btn">
...
$(document).ready(function () {
    ...
    $('.btn-add-option').click(function () {
        ...
        var url = "trans/pnrms/new-option/" + tableName + "/" + title;
        var winWidth = 400;
        var winHeight = 250;
...
//            if ((uploader.files.length + uploader2.files.length) == 0) {
    ...
    function showWindow(obj) {
        var url = "trans/pnrms/option/" + obj.data('table') + "/" + obj.data('title') + '/' + obj.data('hidden') + '/' + obj.attr('name');
        var winWidth = 600;
        var winHeight = 500;

...
<div class="content-wrapper for-overlay ">
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-body">
                <form method="POST" action="trans/nearmiss/new" class="table-responsive" enctype="multipart/form-data" >
                                        ...
                                        <div class="col-sm-3" >
                                            <div class="box box-primary" >
                                                <div class="box-body" >
                                                    ...
                                                    <img id="img_1" src="" class="col-sm-12" width="100%" height="100px" />
                                                </div>
                                        ...
                                        <div class="col-sm-3" >
                                            <div class="box box-success" >
                                                <div class="box-body" >
                                                    ...
                                                    <img id="img_2" src="" class="col-sm-12" width="100%" height="100px" />
                                                </div>
                                                <div class="box-footer" >
                                        ...
                                        <div class="col-sm-3" >
                                            <div class="box box-danger" >
                                                <div class="box-body" >
                                                    ...
                                                    <img id="img_3" src="" class="col-sm-12"  width="100%" height="100px"/>
                                                </div>
                                                <div class="box-footer" >
                                        ...
                                        <div class="col-sm-3" >
                                            <div class="box box-warning" >
                                                <div class="box-body" >
                                                    ...
                                                    <img id="img_4" src="" class="col-sm-12" width="100%" height="100px" />
                                                </div>
                                                <div class="box-footer" >
...
<script type="text/javascript">
                                        $(document).ready(function () {
                                            ...
                                            var uploader = new plupload.Uploader({
                                                ...
                                                url: "{{URL::to('trans/nearmiss/upload')}}",
                                                resize: {
                                                    width: 800,
                                                    quality: 90
                                                },
...
//                                                                $('#btn_del_img_' + num).attr('data-imgid', file.id);
//                                                                $('#btn_del_img_' + num).attr('data-num', num);
//                                                                $('#img_' + (num++) + 'x').attr('src', this.getAsDataURL());
                                                            ...
                                                            $('#image-preview').append('<div class="col-sm-3" >' +
                                                                    ...
                                                                    '<img id = "img_' + num + 'x" src = "' + this.getAsDataURL() + '" class = "col-sm-12 img-prev" width = "100%"  />' +
                                                                    '</div></div></div>');
                                                            num++;
...
//                                                $('#btn_del_img_' + num).hide();
//                                                $('#img_' + (num) + 'x').attr('src', null);

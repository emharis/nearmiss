        ...
        <div class="box box-primary">
                <div class="box-header">
                    <div class="pull-right" >
                        <a href="master/safetyklasifikasi" class="btn btn-danger">Cancel</a>
                    </div>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="master/safetyklasifikasi/edit" method="POST" >
                  ...
                  <div class="box-footer">
                    ...
                    <a class="btn btn-danger" href="master/safetyklasifikasi" >Cancel</a>
                  </div>
                </form>
              </div><!-- /.box -->

    ...
    <section class="content-header">
        <h1>
            ...
            <div class="pull-right" >
                <a class="btn btn-primary bn-sm" href="master/departemen/new" id="btnNew" >New</a>
            </div>
        </h1>
    </section>
                        ...
                        <table class="table table-bordered table-condensed table-striped table-hover ">
                            ...
                            <tbody>
                                ...
                                <tr id="data-{{$dt->id}}" >
                                    ...
                                    <td class="text-right">
                                        <a class="btn btn-xs btn-success btnEdit" href="master/departemen/edit/{{$dt->id}}" >Edit</a>
...
//        alert('Update data dengan javascript dan json');
        ...
        $('#data-' + data.id).children('td').first().next().text(data.code);
        $('#data-' + data.id).children('td').first().next().next().text(data.nama);
        $('#data-' + data.id).children('td').first().next().next().next().text(data.desc);
        $('#data-' + data.id).children('td').first().next().next().next().next().text(data.pic);
    } else {
        location.reload();
    }
}

    ...
    <section class="content-header">
        <h1>
            ...
            <div class="pull-right" >
                <a class="btn btn-primary bn-sm" href="master/vendor/new" id="btnNew" >New</a>
            </div>
        </h1>
    </section>
                        ...
                        <table class="table table-bordered table-condensed table-striped table-hover ">
                            ...
                            <tbody>
                                ...
                                <tr id="data-{{$dt->id}}" >
                                    ...
                                    <td class="text-right">
                                        <a class="btn btn-xs btn-success btnEdit " href="master/vendor/edit/{{$dt->id}}" >Edit</a>
...
$(function () {
    ...
    $('#btnNew').click(function () {
        ...
        showWindow(url, 600, screen.height);
...
//        alert('Update data dengan javascript dan json');
        ...
        $('#data-' + data.id).children('td').first().next().next().next().text(data.desk);
        $('#data-' + data.id).children('td').first().next().next().next().next().text(data.alamat);
        $('#data-' + data.id).children('td').first().next().next().next().next().next().text(data.phone);
    } else {
        location.reload();
    }
}

...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Master Safety Lokasi
            <div class="pull-right" >
                <a class="btn btn-primary bn-sm" href="master/safetylokasi/new" id="btnNew" >New</a>
            </div>
        </h1>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box" >
                    ...
                    <div class="box-body" >
                        <form role="form" id="formFilter" action="master/safetylokasi/filter" method="POST">
                            ...
                            <div class="box-footer">
                                ...
                                @if(isset($isfilter))
                                <a class="btn btn-danger" href="master/safetylokasi" >Clear Filter</a>
                                @endif
                            </div>
                        </form>
                    </div>
                        ...
                        <table class="table table-bordered table-condensed table-striped table-hover ">
                            ...
                            <tbody>
                                ...
                                <tr id="data-{{$dt->id}}" >
                                    ...
                                    <td class="text-right">
                                        <a class="btn btn-xs btn-success btnEdit" href="master/safetylokasi/edit/{{$dt->id}}" >Edit</a>
                                        <a class="btn btn-xs btn-danger btn-delete" href="master/safetylokasi/delete/{{$dt->id}}" >Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                        </table>
